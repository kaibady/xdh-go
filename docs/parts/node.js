function add() {
  return M(
    ...
    n,
    new p.default.Binding('opacity', 'opacity'),
    new p.default.Binding('zOrder', 'zOrder', function(e) {
      return e || 5;
    }),
    new p.default.Binding('zOrder', 'isSelected', function(e, t) {
      return e ? Number.MAX_SAFE_INTEGER : t.data.zOrder;
    }).ofObject(),
    new p.default.Binding('zOrder', 'isHighlighted', function(e, t) {
      return e ? Number.MAX_SAFE_INTEGER : t.data.zOrder;
    }).ofObject(),
    new p.default.Binding('isLayoutPositioned', 'isfixed', function(e) {
      return e;
    }).makeTwoWay(),
    new p.default.Binding('movable', 'ismovable', function(e) {
      return e;
    }).makeTwoWay(),
    M(
      p.default.Panel,
