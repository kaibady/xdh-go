...
::: tip 提示
XdhGoSearch 提供了对节点的模糊搜索功能，多次按回车可以连续搜索[XdhGoSearch](/api.html?url=/xdh-go/doc/module-xdh-go-search.html)
:::
...
<script>
  import { XdhGo, XdhGoSearch } from 'xdh-go';
  export default {
    components: {
      XdhGo,
      XdhGoSearch
...
搜索后的结果会在弹出框中显示出来。示例：分别搜索a,b,c,d,e,f,mike,kate,jack,sam,jason,may
:::demo
