...
<script>
  /**
   * 标签框
   * @module widgets/xdh-form/items/input-tag
   */
  ...
  export default {
     ...
     * 属性参数
     * @member props
     * @property {array} [value] 回填数据值，支持双向绑定
     * @property {string} [placeholder] 占位文本，默认：请输入标签
     * @property {boolean} [collapseTags=false] 是否折叠标签
     * @property {boolean} [disabled=false] 禁用
     * @property {boolean} [readonly=false] 只读
     * @property {string} [size] 显示尺寸，可以选 'medium', 'small', 'mini'
     * @property {string} [icon] 输入框的图标， 默认：el-icon-price-tag
     * @property {boolean} [active] 是否激活输入
     * @property {boolean} [closable] 是否可以关闭tag
     * @property {boolean} [allowCreate] 允许新增
     */
    props: {
      // 标签值
      value: {
