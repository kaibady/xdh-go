...
<script>
  ...
  export default {
     ...
     * @member props
     * @property {String} [type=text] 输入类型，可选 <br>
     *     cascader {@link module:widgets/xdh-form/items/cascader} <br>
     *     checkbox {@link module:widgets/xdh-form/items/checkbox} <br>
     *     color {@link module:widgets/xdh-form/items/color} <br>
     *     date {@link module:widgets/xdh-form/items/date} <br>
     *     divider {@link module:widgets/xdh-form/items/divider} <br>
     *     editor {@link module:widgets/xdh-form/items/editor} <br>
     *     input {@link module:widgets/xdh-form/items/input} <br>
     *     inputTag {@link module:widgets/xdh-form/items/input-tag} <br>
     *     number {@link module:widgets/xdh-form/items/number} <br>
     *     radio {@link module:widgets/xdh-form/items/radio} <br>
     *     range {@link module:widgets/xdh-form/items/range} <br>
     *     rate {@link module:widgets/xdh-form/items/rate} <br>
     *     select {@link module:widgets/xdh-form/items/select} <br>
     *     slider {@link module:widgets/xdh-form/items/slider} <br>
     *     switch {@link module:widgets/xdh-form/items/switch} <br>
     *     tag {@link module:widgets/xdh-form/items/tag} <br>
     *     time {@link module:widgets/xdh-form/items/time} <br>
     *     tree {@link module:widgets/xdh-form/items/tree} <br>
     *     upload {@link module:widgets/xdh-form/items/upload} <br>
     *
